...
def es_apto(candidato: dict):
    ...
    df_candidato = pd.DataFrame([{
        'anios_de_experiencia': candidato['anios_de_experiencia'],
    ...
    return 'Apto 🟢' if prediccion[0] == 1 else 'No Apto 🔴'

nuevo = {
    'anios_de_experiencia': 14,
    'nivel_educativo': 'universitario',
    'expectativa_salarial': 4100000,
    'habilidades': ['Python', 'Java, sql, nosql, excel'],
    'idiomas': ['Inglés']
}
